...
tests = [ {'description': 'PINA: 0xAF => PORTB: 0x0A  PORTC: 0xF0.',
    'steps': [ {'inputs': [('PINA', 0xAF)], 'iterations': 1 } ],
    'expected': [('PORTB', 0x0A), ('PORTC', 0xF0)],
    },
    {'description': 'PINA: 0xE3 => PORTB: 0x0E  PORTC: 0x30.',
    'steps': [ {'inputs': [('PINA', 0xE3)], 'iterations': 1 } ],
    'expected': [('PORTB', 0x0E), ('PORTC', 0x30)],
    },
    ...
    {'description': 'PINA: 0x0E => PORTB: 0x00  PORTC: 0xE0.',
    'steps': [ {'inputs': [('PINA', 0x0E)], 'iterations': 1 } ],
    'expected': [('PORTB', 0x00), ('PORTC', 0xE0)],
    },
    ]
