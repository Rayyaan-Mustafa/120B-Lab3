...
tests = [ {'description': 'PINA: 0x00, PINB: 0x00 => PORTC: 0x00.',
    ...
    {'description': 'PINA: 0x34, PINB: 0x00 => PORTC: 0x03.',
    'steps': [ {'inputs': [('PINA', 0x34), ('PINB', 0x00)], 'iterations': 1 } ],
    'expected': [('PORTC', 0x03)],
    },
    {'description': 'PINA: 0xAB, PINB: 0xC0 => PORTC: 0x07.',
    'steps': [ {'inputs': [('PINA', 0xAB), ('PINB', 0xC0)], 'iterations': 1 } ],
    'expected': [('PORTC', 0x07)],
    },
